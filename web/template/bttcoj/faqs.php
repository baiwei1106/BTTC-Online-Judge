...
<div class="padding">
    ...
    <div style="font-content">
        ...
        <p>
			...
			<br> C++ 使用 <code>g++</code> 编译，命令为 &nbsp;<code>g++ -fno-asm -O2 -fmax-errors=10 -Wall -lm --static -std=c++11 -DONLINE_JUDGE -o Main Main.cc</code>；
            <br> C 使用 <code>gcc</code> 编译，命令为 &nbsp;<code>gcc Main.c -o Main -O2 -fmax-errors=10 -Wall -lm --static -std=c99 -DONLINE_JUDGE</code>；
            <br> Pascal 使用 <code>fpc</code> 编译，命令为 &nbsp;<code>fpc Main.pas -Cs32000000 -Sh -O2 -Co -Ct -Ci</code>。
            <br> Java 使用 <code>OpenJDK</code> 编译，命令为 <code>javac -J-Xms64M -J-Xmx128M -encoding UTF-8 Main.java</code>，如果您的代码中没有 <code>public class</code>，请将入口类命名为 <code>Main</code>。
            <br> Python 执行时会根据您的代码自动选择Python2或Python3解释器。
            <br>
        </p>
